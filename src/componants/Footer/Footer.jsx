...
<Typography sx={{mx : "2px"}} ><a href="https://napps.in/"  target="_blank" rel="noreferrer" style={{color : "yellow" ,textDecoration : "none"}}>Napps.in</a></Typography>           
           <Typography color="#FFF" ></Typography>
           <Typography sx={{mx : "2px"}}><a href="/"  target="_blank" rel="noreferrer" style={{color : "yellow" ,textDecoration : "none"}}></a></Typography>
            </Box>
        </Box>
      </Box>
    </>
