...
export default function FormDialog() {
  ...
  return (
    <>
      ...
      <Box sx={{ display: "flex", color: "#fff", justifyContent: "center", alignItems: "center" }} onClick={
        () => {
          handleClickOpen()
          setRouteSign("signin")
        }
        ...
        />
        <Typography color="black" sx={{ ml: "5px", color: '#fff', fontSize: { xs: "10px", md: "12px" } }}>Login</Typography>
      </Box>
      ...
      <Dialog open={open} onClose={handleClose}>
        ...
        {RouteSign === "signin" &&
          <Box sx={{ width: { xs: "290px", sm: "500px", md: "600px" }, py: "20px", display: "flex", flexDirection: "column", alignItems: "center", bgcolor: "black" }}>
            ...
            <Box sx={{ width: "calc(100% - 20px)", display: "flex", justifyContent: "center", alignItems: "center", }}  >
              ...
              <Typography
                ...
                sx={{
                  fontSize: { xs: "16px", md: "20px" }, color: "blue", textDecoration: "underline",
                  cursor: "pointer",
                  ":hover": {
                    color: "gray"
                  }
            ...
            <Box sx={{ width: "calc(100% - 20px)", display: "flex", justifyContent: "center", alignItems: "center" }}  >
              <Typography sx={{
                fontSize: { xs: "12px", md: "18px" }, color: "blue", textDecoration: "underline",
                cursor: "pointer",
                ":hover": {
                  color: "gray"
                }
          ...
          <Box sx={{ width: { xs: "290px", sm: "500px", md: "600px" }, py: "20px", display: "flex", flexDirection: "column", alignItems: "center" }}>
            ...
            <Box sx={{ display: "flex", alignItems: "center" }}>
              ...
              <Typography
                ...
                sx={{
                  fontSize: { xs: "16px", ml: "10px", md: "20px" }, color: "blue", textDecoration: "underline",
                  cursor: "pointer",
                  ":hover": {
                    color: "gray"
                  }
